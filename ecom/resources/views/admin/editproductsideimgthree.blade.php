...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form action="{{route('updateproductsideimgthree')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="basic-default-name">ảnh cũ</label>
            <div class="col-sm-10">
              <img src="{{asset($product_info->productSideImage3)}}" alt=""/>
            </div>
          </div>
